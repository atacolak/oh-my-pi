...
| `PUPPETEER_EXECUTABLE_PATH`  | Eval browser runtime Chromium executable override                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `HINDSIGHT_RETAIN_UPDATE_MODE`     | `hindsight.retainUpdateMode`    | `replace` or `append`; default `replace`                                          |
