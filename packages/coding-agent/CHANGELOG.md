...
- Fixed project saves leaving live web-search eligibility, tool-activity visibility, remaining display toggles, and MCP notification subscriptions on the rejected local value after adopting a newer disk edit.
