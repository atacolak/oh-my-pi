...
/** Fires when any `hindsight.bankId` / `bankIdPrefix` / `scoping` / `retainUpdateMode` value changes. */
 ...
 * `hindsight.scoping`, or `hindsight.retainUpdateMode` mid-session so subsequent
 * retain/recall calls use the live bank routing and update mode.
 *
